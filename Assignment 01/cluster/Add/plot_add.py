...
plt.title("Compute Throughput vs Problem Size (Add Operation)")
...
plt.title("Memory Bandwidth vs Problem Size (Add Operation)")
plt.grid(True, which="both")
plt.tight_layout()
