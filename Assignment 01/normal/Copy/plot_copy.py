...
plt.title("Compute Throughput vs Problem Size (Copy Operation)")
...
plt.title("Memory Bandwidth vs Problem Size (Copy Operation)")
plt.grid(True, which="both")
plt.tight_layout()
